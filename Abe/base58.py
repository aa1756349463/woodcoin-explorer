...
if __name__ == '__main__':
    x = codecs.decode('005cc87f4a3fdfe3a2346b6953267ca867282630d3f9b78e64', 'hex')
    encoded = b58encode(x)
    print(encoded, '19TbMSWwHvnxAKy12iNm3KdbGfzfaMFViT')
    b58decoded = b58decode(encoded,len(x)).encode()
    print(codecs.encode(b58decoded,'hex').decode())
